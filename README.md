...
1. Get "stackbit-deploy (Read+Write)" API token from your [Sanity management console](https://manage.sanity.io/projects/u74jibdw/settings/api)
...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/sanity-pull --ssg hugo --sanity-project-id u74jibdw --sanity-token $SANITY_ACCESS_TOKEN
...
To start editing your site, you can use the Sanity interface at https://energetic-velociraptor-c679f.sanity.studio/.
...
Generated at `2021-07-12T16:07:14.585Z` by Stackbit version `0.3.53`.